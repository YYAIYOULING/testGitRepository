				...
				<s:form action="api_login" method="post">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="2">
								<textarea name="em.bizContent"  rows='5' cols='75'>{"appId":"10000000000000051504","orderId":"0180620IM902677406","thirdOrderId":"020201031IM9003836","userId":"19002718"}</textarea>
							</td>
						</tr>
						<tr>
							<td width="19%" height="28">result：</td>
							<td colspan="2">
					<textarea name="em.result"  rows='5' cols='75'></textarea>
							</td>
						</tr>
						<tr>
							<td height="30">&nbsp;</td>

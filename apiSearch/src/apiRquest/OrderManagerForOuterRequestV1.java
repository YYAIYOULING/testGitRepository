...
public class OrderManagerForOuterRequestV1 extends AbstractIcbcRequest {

	
	public static class OrderManagerForOuterRequestV1Biz implements BizContent{
		private String requestOrdersStr;
		private List<ThirdPartySubmitRequestOrders> thirdPartySubmitRequestOrders;

		public String getRequestOrdersStr() {
			return requestOrdersStr;
		}

		public void setRequestOrdersStr(String requestOrdersStr) {
			this.requestOrdersStr = requestOrdersStr;
		}
	...
	public Class getBizContentClass() {
		...
		return OrderManagerForOuterRequestV1Biz.class;
	}
